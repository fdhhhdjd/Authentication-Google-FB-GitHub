...
const GITHUB_CLIENT_ID = process.env.GITHUB_CLIENT_IDS;
const GITHUB_CLIENT_SECRET = process.env.GITHUB_CLIENT_SECRETS;

const FACEBOOK_APP_ID = process.env.FACEBOOK_APP_IDS;
const FACEBOOK_APP_SECRET = process.env.FACEBOOK_APP_SECRETS;
